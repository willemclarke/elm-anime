...
module AniList.Object.SiteTrendConnection exposing (..)
...
edges :
    SelectionSet decodesTo AniList.Object.SiteTrendEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) AniList.Object.SiteTrendConnection
edges object____ =
    Object.selectionForCompositeField "edges" [] object____ (Basics.identity >> Decode.nullable >> Decode.list >> Decode.nullable)


nodes :
    SelectionSet decodesTo AniList.Object.SiteTrend
    -> SelectionSet (Maybe (List (Maybe decodesTo))) AniList.Object.SiteTrendConnection
nodes object____ =
...
pageInfo :
    ...
    -> SelectionSet (Maybe decodesTo) AniList.Object.SiteTrendConnection
pageInfo object____ =
