...
module AniList.Object.AiringScheduleConnection exposing (..)
...
edges :
    SelectionSet decodesTo AniList.Object.AiringScheduleEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) AniList.Object.AiringScheduleConnection
edges object____ =
...
pageInfo :
    ...
    -> SelectionSet (Maybe decodesTo) AniList.Object.AiringScheduleConnection
pageInfo object____ =
