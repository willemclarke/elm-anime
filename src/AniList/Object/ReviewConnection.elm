...
module AniList.Object.ReviewConnection exposing (..)
...
edges :
    SelectionSet decodesTo AniList.Object.ReviewEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) AniList.Object.ReviewConnection
edges object____ =
...
pageInfo :
    ...
    -> SelectionSet (Maybe decodesTo) AniList.Object.ReviewConnection
pageInfo object____ =
