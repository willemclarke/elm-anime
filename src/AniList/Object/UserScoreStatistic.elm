...
module AniList.Object.UserScoreStatistic exposing (..)
...
count : SelectionSet Int AniList.Object.UserScoreStatistic
count =
    Object.selectionForField "Int" "count" [] Decode.int


meanScore : SelectionSet Float AniList.Object.UserScoreStatistic
meanScore =
    Object.selectionForField "Float" "meanScore" [] Decode.float


minutesWatched : SelectionSet Int AniList.Object.UserScoreStatistic
minutesWatched =
    Object.selectionForField "Int" "minutesWatched" [] Decode.int


chaptersRead : SelectionSet Int AniList.Object.UserScoreStatistic
chaptersRead =
    Object.selectionForField "Int" "chaptersRead" [] Decode.int


mediaIds : SelectionSet (List (Maybe Int)) AniList.Object.UserScoreStatistic
mediaIds =
    Object.selectionForField "(List (Maybe Int))" "mediaIds" [] (Decode.int |> Decode.nullable |> Decode.list)


score : SelectionSet (Maybe Int) AniList.Object.UserScoreStatistic
score =
