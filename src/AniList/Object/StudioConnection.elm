...
module AniList.Object.StudioConnection exposing (..)
...
edges :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) AniList.Object.StudioConnection
edges object____ =
...
pageInfo :
    ...
    -> SelectionSet (Maybe decodesTo) AniList.Object.StudioConnection
pageInfo object____ =
